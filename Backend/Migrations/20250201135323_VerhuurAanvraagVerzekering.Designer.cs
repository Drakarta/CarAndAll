...
namespace Backend.Migrations
{
    ...
    [Migration("20250201135323_VerhuurAanvraagVerzekering")]
    partial class VerhuurAanvraagVerzekering
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Entities.VerhuurAanvraag", b =>
                {
                    ...
                    b.Property<double>("Verzekering_multiplier")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Backend.Entities.Voertuig", b =>
                {
                    ...
                    b.Property<string>("voertuig_categorie")
                        .IsRequired()
                        .HasMaxLength(8)
                    ...
                    b.HasDiscriminator<string>("voertuig_categorie").HasValue("Voertuig");
            ...
            modelBuilder.Entity("Backend.Entities.Auto", b =>
                {
                    b.HasBaseType("Backend.Entities.Voertuig");
                    ...
                    b.ToTable("Voertuig", t =>
                        {
                            t.Property("Elektrisch")
                                .HasColumnName("Auto_Elektrisch");
                        });

                    b.HasDiscriminator().HasValue("Auto");
                });

            modelBuilder.Entity("Backend.Entities.Camper", b =>
                {
                    b.HasBaseType("Backend.Entities.Voertuig");

                    b.Property<int>("Aantal_slaapplekken")
                        .HasColumnType("int");
                    ...
                    b.ToTable("Voertuig", t =>
                        {
                            t.Property("Aantal_slaapplekken")
                                .HasColumnName("Camper_Aantal_slaapplekken");
                        });

                    b.HasDiscriminator().HasValue("Camper");
                });

            modelBuilder.Entity("Backend.Entities.Caravan", b =>
                {
                    b.HasBaseType("Backend.Entities.Voertuig");
